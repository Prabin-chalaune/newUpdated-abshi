...
const KeenSlider = dynamic(() => import('keen-slider').then((module) => module.default), {
  ssr: false,
});
  ...
  useEffect(() => {
    const loadKeenSlider = async () => {
      ...
      if (keenSliderElement) {
        ...
        const keenSliderPrevious = document.getElementById('keen-slider-previous-desktop');
        const keenSliderNext = document.getElementById('keen-slider-next-desktop');
      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
            <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right lg:col-span-1">
            <h2 className='text-3xl font-bold tracking-tight sm:text-4xl text-green-900'>What our students say about us?</h2>
              ...
              <div id="keen-slider" className="keen-slider">
                ...
                <div className="keen-slider__slide">
                  ...
                  <div>
                        ...
                        <div className="mt-4">
                        <p className="text-2xl font-bold text-rose-600 sm:text-3xl">Sin' Alive</p>
                ...
                <div className="keen-slider__slide">
                  ...
                  <div>
                        ...
                        <div className="mt-4">
                        <p className="text-2xl font-bold text-rose-600 sm:text-3xl"> Alive</p>
